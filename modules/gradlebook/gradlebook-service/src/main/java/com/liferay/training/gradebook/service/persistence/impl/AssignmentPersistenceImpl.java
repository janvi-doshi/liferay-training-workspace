...
public class AssignmentPersistenceImpl
	...
	public void activate() {
		_finderPathWithPaginationFindAll = new FinderPath(
			AssignmentImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(
			AssignmentImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			AssignmentModelImpl.TITLE_COLUMN_BITMASK);
		...
		_finderPathFetchByUUID_G = new FinderPath(
			AssignmentImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
	...
	static {
		try {
			Class.forName(GradebookPersistenceConstants.class.getName());
		}
