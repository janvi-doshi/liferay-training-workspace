...
public class SubmissionPersistenceImpl
	...
	public void activate() {
		_finderPathWithPaginationFindAll = new FinderPath(
			SubmissionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(
			SubmissionImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);
		...
		_finderPathCountByStudentId = new FinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByStudentId", new String[] {Long.class.getName()});
